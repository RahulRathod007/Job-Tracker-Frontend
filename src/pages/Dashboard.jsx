...
// import { getAllJobs, getUserApplications, deleteJob } from '../services/api'
...
//           setJobs(all.filter(j => j.employer?.userId === user.userId))
//         } else {
...
//                         </div>
//                         <span className="status-badge" style={{ background: 'rgba(108,99,255,0.12)', color: '#a29bfe', border: '1px solid rgba(108,99,255,0.3)' }}>
//                           {app.status}
//                         </span>
//                       </div>
